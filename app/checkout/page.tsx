...
function WompiPending({ nombre, apellido, telefono, total, items }: {
  nombre: string; apellido: string; telefono: string; total: number; items: any[]
}) {
  const WA_NUMBER = '573006023544'
  const msg = encodeURIComponent(
    `Hola LUKSO! 👋 Quiero hacer un pedido por *$${total.toLocaleString('es-CO')}.000 COP*\n\nNombre: ${nombre} ${apellido}\nTeléfono: ${telefono}\n\nPor favor indíquenme cómo pagar 🙏`
  )
  return (
    <div>
